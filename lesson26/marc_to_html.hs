...
main :: IO ()
main = do
  marcData <- B.readFile "/home/leo/Downloads/sample.mrc"
...
book1 :: Book
book1 = Book {
  title = "The Conspiracy Against Human Race"
...
-- see the definition of tuple in section 18.2.1 & lesson18/notes18.md
